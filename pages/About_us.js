...
export default function About_us()
{
    let members = [
        {
            'Name': 'Ben Carter',
            'Quote': 'Ben adds some stuff about himself',
        ...
        {
            'Name': 'Katrina Hill',
            'Quote': 'Katrina adds some stuff about herself',
        ...
        {
            'Name': 'Matt Rangel',
            'Quote': 'Matt adds some stuff about himself',
        ...
        {
            'Name': 'Roger Wells',
            'Quote': 'Roger adds some stuff about himself',
    ...
    return (
        <ChakraProvider>
            ...
            <Center bg="grey" marginBottom="50px">
